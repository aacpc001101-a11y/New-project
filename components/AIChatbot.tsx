...
export const AIChatbot: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="absolute bottom-20 right-0 w-[350px] sm:w-[400px] h-[500px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-10 fade-in duration-300">
